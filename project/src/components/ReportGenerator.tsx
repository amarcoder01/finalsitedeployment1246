...
export const generatePDFReport = async (
  ...
  try {
    ...
    const downloadLines = pdf.splitTextToSize(
      downloadAnalysis,
    ...
    const uploadLines = pdf.splitTextToSize(
      uploadAnalysis,
      pageWidth - margin * 2 - 10,
    );
    ...
    // Ping analysis
    let pingColor =
      result.ping < 20 ? "#10B981" : result.ping < 50 ? "#FBBF24" : "#EF4444";
    ...
    const pingLines = pdf.splitTextToSize(
      pingAnalysis,
      pageWidth - margin * 2 - 10,
    );
    ...
    const jitterLines = pdf.splitTextToSize(
      jitterAnalysis,
      pageWidth - margin * 2 - 10,
    );
  ...
  return (
    ...
    >
      ...
      <div className="mt-4 p-4 bg-gray-50 rounded-lg">
        <p className="text-sm text-gray-600">
          <strong>Privacy Note:</strong> Reports are generated locally in your
