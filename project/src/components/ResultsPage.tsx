...
const ResultsPage: React.FC = () => {
  ...
  const ResultCard = ({
    ...
    >
      ...
      <div
        className={`p-2 sm:p-3 rounded-full mb-2 sm:mb-3 ${color.replace("bg-", "bg-").replace("-500", "-100")}`}
      >
        {icon}
      </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 text-sm">
            ...
            <div className="p-4 bg-gray-50 rounded-lg">
              ...
              <p className="font-medium">
                {result.userLocation.city}, {result.userLocation.country}
              </p>
            </div>
            <div className="p-4 bg-gray-50 rounded-lg">
              <p className="text-gray-500 mb-1">Test Duration</p>
              <p className="font-medium">
                {result.testDuration.toFixed(1)} seconds
              </p>
            </div>
            <div className="p-4 bg-gray-50 rounded-lg">
            ...
            {result.bufferbloat && (
              <div className="p-4 bg-gray-50 rounded-lg">
                ...
                <p className="font-medium">
                  ...
                  {result.bufferbloat.latencyIncrease.toFixed(1)} ms)
                </p>
              </div>
            )}
            {result.stability && (
              <div className="p-4 bg-gray-50 rounded-lg">
                ...
                <p className="font-medium">
                  {result.stability.score.toFixed(1)}%
                </p>
              </div>
            )}
          </div>
