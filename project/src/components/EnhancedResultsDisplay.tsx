...
const EnhancedResultsDisplay: React.FC<EnhancedResultsDisplayProps> = ({
  ...
  const [activeTab, setActiveTab] = useState<"results" | "history" | "reports">(
    "results",
  );
                ...
                <div className="bg-white rounded-xl p-4 sm:p-6 shadow-lg border border-gray-100">
                  ...
                  <div className="space-y-3 sm:space-y-4">
                    <div className="flex justify-between items-center p-2 sm:p-3 bg-gray-50 rounded-lg">
                      ...
                      <span
                        className={`text-sm sm:text-base font-semibold ${result.downloadSpeed > 25 ? "text-green-600" : result.downloadSpeed > 10 ? "text-yellow-600" : "text-red-600"}`}
                      >
                    ...
                    <div className="flex justify-between items-center p-2 sm:p-3 bg-gray-50 rounded-lg">
                      ...
                      <span
                        className={`text-sm sm:text-base font-semibold ${result.uploadSpeed > 10 ? "text-green-600" : result.uploadSpeed > 5 ? "text-yellow-600" : "text-red-600"}`}
                      >
                    ...
                    <div className="flex justify-between items-center p-2 sm:p-3 bg-gray-50 rounded-lg">
                      ...
                      <span
                        className={`text-sm sm:text-base font-semibold ${result.ping < 20 ? "text-green-600" : result.ping < 50 ? "text-yellow-600" : "text-red-600"}`}
                      >
                        {result.ping < 20
                          ? "Excellent"
                          : result.ping < 50
                  ...
                  <div className="bg-white rounded-xl p-4 sm:p-6 shadow-lg border border-gray-100">
                    ...
                    <div className="space-y-3 sm:space-y-4">
                      <div className="flex justify-between items-center">
                        ...
                        <div
                          className={`px-2 sm:px-3 py-0.5 sm:py-1 rounded-full text-sm sm:text-base font-semibold ${result.bufferbloat.rating === "A" ? "bg-green-100 text-green-700" : result.bufferbloat.rating === "B" ? "bg-blue-100 text-blue-700" : result.bufferbloat.rating === "C" ? "bg-yellow-100 text-yellow-700" : "bg-red-100 text-red-700"}`}
                        >
