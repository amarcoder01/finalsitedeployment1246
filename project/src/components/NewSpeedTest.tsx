        ...
        >
            ...
            <div className="flex flex-col space-y-3">
              <div className="flex items-center justify-between mb-3">
                ...
                <select
                  ...
                  onChange={(e) =>
                    setSelectedProtocol(e.target.value as TestProtocol)
                  }
                  disabled={isTestRunning}
                >
                  <option value={TestProtocol.XHR}>XHR/Fetch (Standard)</option>
                  <option value={TestProtocol.WEBSOCKET}>
                ...
                {!isTestRunning && !testResult && (
                  ...
                  >
                    ...
                    <p className="mt-4 text-gray-600 text-center max-w-sm">
                      Click to test your download speed, upload speed, ping, and
                      more
                    </p>
                  </motion.div>
                )}
                  ...
                  >
                    <svg className="w-full h-full" viewBox="0 0 100 100">
                      ...
                      <motion.circle
                          ...
                          testProgress.phase === "download"
                            ...
                            : testProgress.phase === "upload"
                              ...
                              : testProgress.phase === "ping"
                                ? "#3B82F6"
                                : testProgress.phase === "bufferbloat"
                                  ? "#8B5CF6"
                                  : testProgress.phase === "packetLoss"
                                    ? "#FBBF24"
                                    : "#6366F1"
                        }
                        strokeWidth="8"
                        strokeDasharray="283"
                        strokeDashoffset={
                          283 - (283 * testProgress.progress) / 100
                        }
                        strokeLinecap="round"
                    ...
                    <div className="grid grid-cols-3 gap-6 mb-6">
                      <div className="flex flex-col items-center">
                        ...
                        <span className="text-2xl font-bold text-gray-800">
                          {testResult.downloadSpeed.toFixed(1)}
                        </span>
                        <span className="text-sm text-gray-500">
                          Mbps Download
                        </span>
                      ...
                      <div className="flex flex-col items-center">
                        ...
                        <span className="text-2xl font-bold text-gray-800">
                          {testResult.uploadSpeed.toFixed(1)}
                        </span>
                        <span className="text-sm text-gray-500">
                          Mbps Upload
                        </span>
          ...
          <div className="px-6 py-4 bg-gray-50 border-t border-gray-100 flex items-center justify-between text-sm text-gray-500">
            <div className="flex items-center gap-2">
              ...
              <span>
                Server: {testResult?.serverLocation || selectedServer}
              </span>
            </div>
            <div>Powered by SpeedTest Pro</div>
          </div>
        </motion.div>
            ...
            {testResult.bufferbloat && (
              <div className="bg-white rounded-xl shadow-md p-6 border border-gray-100">
                ...
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div
                    className={`px-3 py-1 rounded-full text-sm font-medium ${
                      testResult.bufferbloat.rating === "A"
                        ? "bg-green-100 text-green-800"
                        : testResult.bufferbloat.rating === "B"
                          ? "bg-blue-100 text-blue-800"
                          : testResult.bufferbloat.rating === "C"
                            ? "bg-yellow-100 text-yellow-800"
                            : testResult.bufferbloat.rating === "D"
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-medium text-gray-800">
                    {testResult.bufferbloat.latencyIncrease} ms
                  </span>
                </div>
                <p className="mt-4 text-sm text-gray-600">
                  Bufferbloat occurs when your connection gets congested,
                  causing delays. A lower rating indicates potential issues
                  during heavy usage.
                </p>
              </div>
            )}
            ...
            {testResult.protocolOverhead && (
              <div className="bg-white rounded-xl shadow-md p-6 border border-gray-100">
                ...
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div
                    className={`px-3 py-1 rounded-full text-sm font-medium ${
                      testResult.protocolOverhead.detected
                        ? "bg-green-100 text-green-800"
                        : "bg-blue-100 text-blue-800"
                    }`}
                  >
                ...
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="font-medium text-gray-800">
                    {testResult.protocolOverhead.factor.toFixed(3)}x
                  </span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-gray-600">Overhead Percentage</span>
                  <span className="font-medium text-gray-800">
                    {testResult.protocolOverhead.overheadPercentage.toFixed(1)}%
                  </span>
                </div>
                <p className="mt-4 text-sm text-gray-600">
                  Protocol overhead represents the extra data needed to transmit
                  your actual content. This includes headers, encryption, and
