...
const NetworkSpeedGuide: React.FC<NetworkSpeedGuideProps> = ({
  isOpen,
  onClose,
}) => {
  return (
          ...
          >
              ...
              <div className="space-y-5 sm:space-y-6">
                ...
                >
                  ...
                  <p className="text-sm sm:text-base text-blue-700">
                    A speed test measures your internet connection's performance
                    by checking download speed, upload speed, and ping
                    (latency). This helps you understand if you're getting the
                    service you're paying for from your ISP.
                  </p>
                </motion.div>
                  ...
                  <div className="grid gap-3 sm:gap-4">
                    ...
                    >
                      ...
                      <p className="text-sm sm:text-base text-gray-600 ml-13">
                        Measures how quickly data is transferred from the
                        internet to your device. Higher is better for streaming
                        videos, downloading files, and browsing websites.
                      </p>
                    </motion.div>
                    ...
                    >
                      ...
                      <p className="text-sm sm:text-base text-gray-600 ml-13">
                        Measures how quickly data is transferred from your
                        device to the internet. Important for video calls,
                        uploading files to cloud storage, and online gaming.
                      </p>
                    </motion.div>
                    ...
                    >
                      ...
                      <p className="text-sm sm:text-base text-gray-600 ml-13">
                        Measures the time it takes for data to travel from your
                        device to a server and back. Lower is better, especially
                    ...
                    >
                      ...
                      <p className="text-sm sm:text-base text-gray-600 ml-13">
                        Measures the variation in ping over time. Lower jitter
                        means a more stable connection, which is important for
                        real-time applications like video calls and online
                        gaming.
                      </p>
                    </motion.div>
                  </div>
                ...
                >
                  ...
                  <ul className="space-y-2 sm:space-y-3 text-sm sm:text-base text-green-800 list-disc pl-5">
                    <li>
                      Position your router in a central location, away from
                      walls and metal objects
                    </li>
                    <li>Use a wired Ethernet connection when possible</li>
                    <li>Update your router's firmware regularly</li>
                    <li>
                      Secure your Wi-Fi with a password to prevent unauthorized
                      users
                    </li>
                    <li>
                      Consider upgrading your router if it's more than 3-4 years
                      old
                    </li>
                    <li>
                      Close unused applications and limit the number of devices
                      connected simultaneously
                    </li>
                    <li>
                      Contact your ISP if speeds are consistently below what
                      you're paying for
                    </li>
                  </ul>
                </motion.div>
            ...
            <div className="bg-gradient-to-r from-gray-50 to-gray-100 px-6 py-4 rounded-b-2xl border-t border-gray-200">
              <p className="text-sm text-gray-600 text-center">
                Remember that internet speed can vary based on many factors. If
                you've tried these tips and still experience issues, contact
