...
const ModernShareModal: React.FC<ModernShareModalProps> = ({
  result,
  onClose,
}) => {
            ...
            <div className="bg-gradient-to-r from-blue-50 to-purple-50 p-4 sm:p-5 rounded-xl border border-blue-100 result-capture-area">
              ...
              <div className="grid grid-cols-3 gap-3 sm:gap-4 text-center">
                <div className="bg-white p-3 sm:p-4 rounded-lg shadow-sm">
                  <div className="text-green-600 font-bold text-lg sm:text-2xl">
                ...
                <div className="bg-white p-3 sm:p-4 rounded-lg shadow-sm">
                  <div className="text-blue-600 font-bold text-lg sm:text-2xl">
                ...
                <div className="bg-white p-3 sm:p-4 rounded-lg shadow-sm">
                  <div className="text-amber-600 font-bold text-lg sm:text-2xl">
                    ...
                    {(() => {
                      const packetLossValue =
                        typeof result.packetLoss === "number"
                          ? result.packetLoss
                          : result.packetLoss?.percentage;
                      return typeof packetLossValue === "number"
                        ? packetLossValue.toFixed(1)
                        : "0.0";
                    })()}
                    %
                  </div>
