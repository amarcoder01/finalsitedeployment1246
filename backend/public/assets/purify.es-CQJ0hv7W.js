...
let { freeze: S, seal: y, create: _t } = Object,
  { apply: we, construct: xe } = typeof Reflect < "u" && Reflect;
S ||
  (S = function (o) {
    return o;
  });
...
const le = R(Array.prototype.forEach),
  jt = R(Array.prototype.lastIndexOf),
  st = R(Array.prototype.pop),
  $ = R(Array.prototype.push),
  Vt = R(Array.prototype.splice),
  fe = R(String.prototype.toLowerCase),
  Ne = R(String.prototype.toString),
  lt = R(String.prototype.match),
  q = R(String.prototype.replace),
  $t = R(String.prototype.indexOf),
  qt = R(String.prototype.trim),
  L = R(Object.prototype.hasOwnProperty),
...
function R(r) {
  return function (o) {
    ...
    for (
      var l = arguments.length, s = new Array(l > 1 ? l - 1 : 0), T = 1;
      T < l;
      T++
    )
      s[T - 1] = arguments[T];
...
const ct = S([
  ...
  ce = S(["xlink:href", "xml:id", "xlink:title", "xml:space", "xmlns:xlink"]),
  en = y(/\{\{[\w\W]*|[\w\W]*\}\}/gm),
  tn = y(/<%[\w\W]*|[\w\W]*%>/gm),
  nn = y(/\$\{[\w\W]*/gm),
  on = y(/^data-[\-\w.\u00B7-\uFFFF]+$/),
...
function ht() {
  ...
  if (
    ((o.version = "3.2.6"),
    (o.removed = []),
    !r || !r.document || r.document.nodeType !== J.document || !r.Element)
  )
  ...
  const zt = l.createElement("form"),
    ...
    ye = function () {
      ...
      if (!(H && H === e)) {
        if (
          ...
          (e = C(e)),
          (j =
            Ft.indexOf(e.PARSER_MEDIA_TYPE) === -1 ? Ht : e.PARSER_MEDIA_TYPE),
          (p = j === "application/xhtml+xml" ? Ne : fe),
          (m = L(e, "ALLOWED_TAGS") ? a({}, e.ALLOWED_TAGS, p) : Ue),
          (d = L(e, "ALLOWED_ATTR") ? a({}, e.ALLOWED_ATTR, p) : Fe),
          (Oe = L(e, "ALLOWED_NAMESPACES")
            ? a({}, e.ALLOWED_NAMESPACES, Ne)
            : kt),
          (Se = L(e, "ADD_URI_SAFE_ATTR")
            ? a(C(Ve), e.ADD_URI_SAFE_ATTR, p)
            : Ve),
          (Xe = L(e, "ADD_DATA_URI_TAGS")
            ? a(C(je), e.ADD_DATA_URI_TAGS, p)
            : je),
          (U = L(e, "FORBID_CONTENTS") ? a({}, e.FORBID_CONTENTS, p) : Ye),
          (Y = L(e, "FORBID_TAGS") ? a({}, e.FORBID_TAGS, p) : C({})),
          (_e = L(e, "FORBID_ATTR") ? a({}, e.FORBID_ATTR, p) : C({})),
          (k = L(e, "USE_PROFILES") ? e.USE_PROFILES : !1),
          (He = e.ALLOW_ARIA_ATTR !== !1),
          (Ee = e.ALLOW_DATA_ATTR !== !1),
          (ze = e.ALLOW_UNKNOWN_PROTOCOLS || !1),
          (Ge = e.ALLOW_SELF_CLOSE_IN_ATTR !== !1),
          ...
          (Ae = e.KEEP_CONTENT !== !1),
          (X = e.IN_PLACE || !1),
          (ke = e.ALLOWED_URI_REGEXP || Et),
          (F = e.NAMESPACE || b),
          (re = e.MATHML_TEXT_INTEGRATION_POINTS || re),
          (se = e.HTML_INTEGRATION_POINTS || se),
          (f = e.CUSTOM_ELEMENT_HANDLING || {}),
          e.CUSTOM_ELEMENT_HANDLING &&
            $e(e.CUSTOM_ELEMENT_HANDLING.tagNameCheck) &&
            (f.tagNameCheck = e.CUSTOM_ELEMENT_HANDLING.tagNameCheck),
          e.CUSTOM_ELEMENT_HANDLING &&
            $e(e.CUSTOM_ELEMENT_HANDLING.attributeNameCheck) &&
          ...
          k &&
            ((m = a({}, ft)),
            (d = []),
            k.html === !0 && (a(m, ct), a(d, ut)),
            k.svg === !0 && (a(m, be), a(d, Ce), a(d, ce)),
            k.svgFilters === !0 && (a(m, Ie), a(d, Ce), a(d, ce)),
            k.mathMl === !0 && (a(m, Me), a(d, mt), a(d, ce))),
          e.ADD_TAGS && (m === Ue && (m = C(m)), a(m, e.ADD_TAGS, p)),
          e.ADD_ATTR && (d === Fe && (d = C(d)), a(d, e.ADD_ATTR, p)),
          e.ADD_URI_SAFE_ATTR && a(Se, e.ADD_URI_SAFE_ATTR, p),
          e.FORBID_CONTENTS &&
            (U === Ye && (U = C(U)), a(U, e.FORBID_CONTENTS, p)),
          Ae && (m["#text"] = !0),
          w && a(m, ["html", "head", "body"]),
          m.table && (a(m, ["tbody"]), delete Y.tbody),
          ...
          (g === void 0 && (g = fn(Q, T)),
            g !== null && typeof B == "string" && (B = g.createHTML("")));
        (S && S(e), (H = e));
      }
    },
    qe = a({}, [...be, ...Ie, ...Jt]),
          ...
          : e.namespaceURI === ie
            ...
            : e.namespaceURI === b
              ? (t.namespaceURI === ae && !se[c]) ||
                (t.namespaceURI === ie && !re[c])
                ? !1
                : !Ke[n] && (Ut[n] || !qe[n])
              : !!(j === "application/xhtml+xml" && Oe[e.namespaceURI])
        : !1;
    },
    D = function (e) {
      $(o.removed, { element: e });
    ...
    z = function (e, t) {
      try {
        $(o.removed, { attribute: t.getAttributeNode(e), from: t });
      } catch {
    ...
    Ze = function (e) {
      ...
      return (
        ...
        F === b ? It.call(t, w ? "html" : "body")[0] : w ? t.documentElement : _
      );
    },
    Je = function (e) {
      return Nt.call(
  ...
  const et = function (e) {
      let t = null;
      if ((I(h.beforeSanitizeElements, e, null), Le(e))) return (D(e), !0);
      const n = p(e.nodeName);
      if (
        (I(h.uponSanitizeElement, e, { tagName: n, allowedTags: m }),
        (te &&
          e.hasChildNodes() &&
          ...
          (te && e.nodeType === J.comment && A(/<[/\w]/g, e.data)))
      )
        return (D(e), !0);
      if (!m[n] || Y[n]) {
        if (
          !Y[n] &&
          nt(n) &&
          ((f.tagNameCheck instanceof RegExp && A(f.tagNameCheck, n)) ||
            (f.tagNameCheck instanceof Function && f.tagNameCheck(n)))
        )
          return !1;
        if (Ae && !U[n]) {
          const c = ee(e) || e.parentNode,
            _ = Dt(e) || e.childNodes;
          if (_ && c) {
            const u = _.length;
            for (let O = u - 1; O >= 0; --O) {
              const M = Ot(_[O], !0);
              ((M.__removalCount = (e.__removalCount || 0) + 1),
                c.insertBefore(M, Lt(e)));
            }
          }
        }
        return (D(e), !0);
      }
      return (e instanceof Pe && !Gt(e)) ||
        ...
        : (P &&
            ...
            e.textContent !== t &&
              ($(o.removed, { element: e.cloneNode() }), (e.textContent = t))),
          I(h.afterSanitizeElements, e, null),
          !1);
    },
    tt = function (e, t, n) {
    ...
    ot = function (e) {
      ...
      for (; c--; ) {
        const _ = t[c],
          { name: u, namespaceURI: O, value: M } = _,
          V = p(u),
          De = M;
        ...
        if (
          ...
          I(h.uponSanitizeAttribute, e, n),
          (E = n.attrValue),
          Be && (V === "id" || V === "name") && (z(u, e), (E = vt + E)),
          te && A(/((--!?|])>)|<\/(style|title)/i, E))
        ) {
          z(u, e);
          continue;
        }
        ...
        if (E !== De)
          try {
            (O ? e.setAttributeNS(O, u, E) : e.setAttribute(u, E),
              Le(e) ? D(e) : st(o.removed));
          } catch {
            z(u, e);
          }
      }
    ...
    Wt = function i(e) {
      ...
      for (I(h.beforeSanitizeShadowDOM, e, null); (t = n.nextNode()); )
        (I(h.uponSanitizeShadowNode, t, null),
          et(t),
          ot(t),
          t.content instanceof N && i(t.content));
  ...
  return (
    (o.sanitize = function (i) {
      ...
      if (
        (ge || ye(e), (o.removed = []), typeof i == "string" && (X = !1), X)
      ) {
        if (i.nodeName) {
        ...
        ((t = Ze("<!---->")),
          ...
          (n.nodeType === J.element && n.nodeName === "BODY") ||
          n.nodeName === "HTML"
            ? (t = n)
            : t.appendChild(n));
      else {
      ...
      if (v) {
        ...
        return (
          (d.shadowroot || d.shadowrootmode) && (_ = Mt.call(s, _, !0)),
          _
        );
      }
      ...
      return (
        w &&
          ...
          A(gt, t.ownerDocument.doctype.name) &&
          (O =
            "<!DOCTYPE " +
            t.ownerDocument.doctype.name +
            `>
