import { a as Ma } from "./pdf-BDHYIwva.js";
import { g as Qu } from "./vendor-B_qP7WtP.js";
var on = {},
  un = {},
  ur,
  ln;
  ...
  return (
    (Dt.f = n
      ...
      : function (f, v, g) {
          ...
          return ("value" in g && (f[v] = g.value), f);
        }),
    Dt
  );
}
...
function Dr() {
  ...
  return ((Bt = { EXISTS: i, PROPER: a, CONFIGURABLE: s }), Bt);
}
var Ft, Jn;
function Ga() {
  if (Jn) return Ft;
...
function Vr() {
  ...
  return ((zt = { set: c, get: f, has: v, enforce: g, getterFor: d }), zt);
}
var as;
function sl() {
  ...
  var n = re(),
    ...
    y = (jt.exports = function (m, b, x) {
      (f(h(b), 0, 7) === "Symbol(" &&
        (b = "[" + v(h(b), /^Symbol\(([^)]*)\).*$/, "$1") + "]"),
        x && x.getter && (b = "get " + b),
        x && x.setter && (b = "set " + b),
        (!t(m, "name") || (a && m.name !== b)) &&
          (i ? c(m, "name", { value: b, configurable: !0 }) : (m.name = b)),
        d &&
          x &&
          t(x, "arity") &&
          m.length !== x.arity &&
          c(m, "length", { value: x.arity }));
      try {
        x && t(x, "constructor") && x.constructor
          ? i && c(m, "prototype", { writable: !1 })
          : m.prototype && (m.prototype = void 0);
      } catch {}
      var S = u(m);
      return (
        t(S, "source") || (S.source = g(p, typeof b == "string" ? b : "")),
        m
      );
    });
  return (
...
function ol() {
  ...
  return ((Jt = { includes: t(!0), indexOf: t(!1) }), Jt);
}
var ei, cs;
function ul() {
  if (cs) return ei;
    ...
    (si = function (o, u) {
      ...
      if (
        ...
        for (g in u) {
          if (
            ((p = u[g]),
            o.dontCallGetSet ? ((y = e(v, g)), (d = y && y.value)) : (d = v[g]),
            (f = s(h ? g : l + (c ? "." : "#") + g, o.forced)),
            !f && d !== void 0)
          ) {
            if (typeof p == typeof d) continue;
            a(p, d);
          }
          ((o.sham || (d && d.sham)) && r(p, "sham", !0), t(v, g, p, o));
        }
    }),
    si
  );
      ...
      return t("Bun/")
        ...
        : t("Cloudflare-Workers")
          ...
          : t("Deno/")
            ...
            : t("Node.js/")
              ? "NODE"
              : n.Bun && typeof Bun.version == "string"
                ? "BUN"
                : n.Deno && typeof Deno.version == "object"
                  ? "DENO"
                  : r(n.process) === "process"
                    ? "NODE"
                    : n.window && n.document
      ...
      ("__proto__" in {}
        ? (function () {
            var i = !1,
              ...
              s;
            try {
              ((s = n(Object.prototype, "__proto__", "set")),
                s(a, []),
        ...
        : d && d.now
          ...
          : y && !h
            ...
            : n.addEventListener &&
                ...
                E.protocol !== "file:" &&
                !a(k)
              ? ((O = k), n.addEventListener("message", w, !1))
              : S in u("script")
                ? (O = function (R) {
...
function ch() {
  ...
  if (!v) {
    var b = new i(),
      x = function () {
        var S, E;
        for (u && (S = c.domain) && S.exit(); (E = b.get()); )
          try {
            E();
          } catch (O) {
            throw (b.head && g(), O);
    ...
    (!a && !u && !o && l && h
      ? ((d = !0),
        (p = h.createTextNode("")),
        new l(x).observe(p, { characterData: !0 }),
        (g = function () {
          p.data = d = !d;
        }))
      : !s && f && f.resolve
    ...
    v = t("Promise", function () {
      ...
      if (!u || u < 51 || !/native code/.test(g)) {
        var p = new e(function (b) {
          ...
          m = (p.constructor = {});
        if (((m[h] = y), (c = p.then(function () {}) instanceof y), !c))
          return !0;
      }
      return !d && (s === "BROWSER" || s === "DENO") && !f;
    });
  return ((ki = { CONSTRUCTOR: v, REJECTION_EVENT: f, SUBCLASSING: c }), ki);
}
var ji = {},
  Zs;
function pr() {
...
function gh() {
  ...
  var n = le(),
    ...
    N = E.f,
    L = N,
    B = !!(I && I.createEvent && t.dispatchEvent),
    ...
    he = function (C, q) {
      ...
      try {
        W
          ? ($ || (q.rejection === Ae && xr(q), (q.rejection = De)),
            W === !0
              ? (Te = G)
              : (Oe && Oe.enter(), (Te = W(G)), Oe && (Oe.exit(), (or = !0))),
            Te === C.promise
              ? Ve(new U("Promise-chain cycle"))
              : (We = Ne(Te))
                ? i(We, Te, _e, Ve)
                : _e(Te))
          : Ve(G);
    ...
    be = function (C, q) {
      C.notified ||
        ((C.notified = !0),
        d(function () {
          for (var G = C.reactions, $; ($ = G.get()); ) he($, C);
          ((C.notified = !1), q && !C.rejection && br(C));
        }));
    },
    Ue = function (C, q, G) {
      var $, W;
      (B
        ...
        !V && (W = t["on" + C])
          ? W($)
          : C === z && p("Unhandled promise rejection", G));
    },
    br = function (C) {
      i(g, t, function () {
        var q = C.facade,
    ...
    ve = function (C, q, G) {
      C.done ||
        ((C.done = !0), G && (C = G), (C.value = q), (C.state = Fe), be(C, !0));
    },
    xe = function (C, q, G) {
      if (!C.done) {
        ((C.done = !0), G && (C = G));
        try {
          ...
          $
            ? d(function () {
                var W = { done: !1 };
                try {
                  i($, q, ge(xe, W, C), ge(ve, W, C));
                } catch (_e) {
                  ve(W, _e, C);
                }
              })
            : ((C.value = q), (C.state = Q), be(C, !1));
        } catch (W) {
          ve({ done: !1 }, W, C);
        }
      }
  ...
  if (
    ...
    (pe.prototype = a(A, "then", function (q, G) {
      var $ = M(this),
        W = N(v(this, R));
      return (
        ($.parent = !0),
    ...
    (ye = function () {
      var C = new pe(),
        q = M(C);
      ((this.promise = C),
        (this.resolve = ge(xe, q)),
        (this.reject = ge(ve, q)));
    }),
    (E.f = N =
      function (C) {
        return C === R || C === me ? new ye(C) : L(C);
      }),
  ...
  return (
    n({ global: !0, constructor: !0, wrap: !0, forced: _ }, { Promise: R }),
    o(R, O, !1, !0),
    u(O),
    un
  );
  ...
  return (
    (zi = function (v, g, d) {
      ...
      if (m) E = v.iterator;
        ...
        if (((O = u(v)), !O)) throw new h(t(v) + " is not iterable");
        if (i(O)) {
          for (_ = 0, V = a(v); V > _; _++)
            if (((P = R(v[_])), P && s(f, P))) return P;
          return new c(!1);
        }
        E = o(v, O);
      }
      for (M = m ? v.next : E.next; !(w = e(M, E)).done; ) {
        try {
          P = R(w.value);
        } catch (A) {
          l(E, "throw", A);
            ...
            v = i(function () {
              ...
              (a(u, function (m) {
                var b = p++,
                  x = !1;
                (y++,
                  e(g, l, m).then(function (S) {
                    x || ((x = !0), (d[b] = S), --y || c(d));
                  }, f));
              }),
                --y || c(d));
            });
          return (v.error && f(v.value), h.promise);
        },
      },
    ),
    eo
...
function Th() {
  ...
  return (
    n(
      { target: "Promise", stat: !0, forced: r },
      {
        reject: function (i) {
          var a = e.f(this),
            s = a.reject;
...
function Tl() {
  ...
  return ((Qi = { BROKEN_CARET: a, MISSED_STICKY: i, UNSUPPORTED_Y: t }), Qi);
}
var Zi = {},
  Ji,
  wo;
  ...
  return (
    (Zi.f =
      n && !e
        ...
        : function (o, u) {
            t(o);
            for (var l = i(u), h = a(u), c = h.length, f = 0, v; c > f; )
              r.f(o, (v = h[f++]), l[v]);
            return o;
          }),
    Zi
  ...
  var n = ue(),
    ...
    d = function () {
      ...
      return (
        ...
        i.appendChild(m),
        (m.src = String(b)),
        (x = m.contentWindow.document),
        x.open(),
        x.write(v("document.F=Object")),
        x.close(),
        x.F
      );
    },
  ...
  return (
    ...
    (ea =
      ...
      function (b, x) {
        ...
        return (
          b !== null
            ? ((f[l] = n(b)), (S = new f()), (f[l] = null), (S[c] = b))
            : (S = y()),
          x === void 0 ? S : e.f(S, x)
        );
      }),
...
`)) &&
          ...
          N
            ? R
              ...
              : (O.lastIndex = 0)
            : y && R && (O.lastIndex = O.global ? R.index + R[0].length : k),
          b &&
            R &&
            R.length > 1 &&
            n(h, R[0], w, function () {
...
function Za() {
  ...
  return (
    (aa = function (u, l, h, c) {
      ...
      if (!v || !g || h) {
        var d = /./[f],
          p = l(f, ""[u], function (y, m, b, x, S) {
            var E = m.exec;
            return E === r || E === o.exec
              ? v && !S
                ? { done: !0, value: n(d, m, b, x) }
                : { done: !0, value: n(y, b, m, x) }
              : { done: !1 };
          });
        (e(String.prototype, u, p[0]), e(o, f, p[1]));
      }
      c && a(o[f], "sham", !0);
    }),
    aa
...
function Nh() {
  ...
  return ((na = { codeAt: o(!1), charAt: o(!0) }), na);
}
var sa, Vo;
function Ja() {
  if (Vo) return sa;
      ...
      return [
        ...
        function (v) {
          ...
          for (var m = [], b = 0, x; (x = l(g, d)) !== null; ) {
            var S = a(x[0]);
            ((m[b] = S),
              S === "" && (g.lastIndex = u(d, i(g.lastIndex), y)),
              b++);
          }
          return b === 0 ? null : m;
        },
      ...
      function (w, k, R) {
        ...
        return [
          ...
          function (U, I) {
            ...
            var z = j.global,
              X;
            z && ((X = j.unicode), (j.lastIndex = 0));
            for (
              var H = [], Q;
              (Q = d(j, N)), !(Q === null || (S(H, Q), !z));

            ) {
              var Fe = h(Q[0]);
              Fe === "" && (j.lastIndex = f(N, l(j.lastIndex), X));
            }
            for (var De = "", Ae = 0, pe = 0; pe < H.length; pe++) {
              Q = H[pe];
              for (
                var ye = h(Q[0]),
                  me = m(b(u(Q.index), N.length), 0),
                  Ie = [],
                  Ne,
                  he = 1;
                he < Q.length;
              ...
              if (B) {
                var Ue = x([ye], Ie, me, N);
                (be !== void 0 && S(Ue, be), (Ne = h(n(I, void 0, Ue))));
              } else Ne = g(ye, N, me, Ie, be, I);
              me >= Ae && ((De += O(N, Ae, me) + Ne), (Ae = me + ye.length));
            }
            return De + O(N, Ae);
          },
        ];
...
function rn() {
  ...
  return (
    (ha = function (r) {
      if (n(r)) throw new e("The method doesn't accept regular expressions");
      return r;
    }),
    ha
  );
...
function Vh() {
  ...
  var n = le(),
    ...
    f =
      ...
      !c &&
      !!(function () {
        var v = r(String.prototype, "startsWith");
        return v && !v.writable;
      })();
  return (
    n(
      { target: "String", proto: !0, forced: !f && !c },
      {
...
function Lh() {
  ...
  var n = ne(),
    ...
    i = Array.prototype;
  return (
    i[t] === void 0 && r(i, t, { configurable: !0, value: e(null) }),
    (ca = function (a) {
      i[t][a] = !0;
    }),
    ca
...
function El() {
  ...
  [].keys &&
    ((f = [].keys()),
    "next" in f
      ? ((c = i(i(f))), c !== Object.prototype && (h = c))
      : (l = !0));
  var v =
    !r(h) ||
    n(function () {
  ...
  return (
    ...
    (da = { IteratorPrototype: h, BUGGY_SAFARI_ITERATORS: l }),
    da
  );
}
var pa, Qo;
  ...
  return (
    (ya = function (O, _, V, P, M, w, k) {
      ...
      var R = function (H) {
        ...
        U = !1,
        I = O.prototype,
        j = I[m] || I["@@iterator"] || (M && I[M]),
        N = (!y && j) || R(M),
        L = (_ === "Array" && I.entries) || j,
        B,
        z,
        X;
      if (
        ...
        if (((z = { values: R(x), keys: w ? N : R(b), entries: R(S) }), k))
          for (X in z) (y || U || !(X in I)) && h(I, X, z[X]);
        else n({ target: _, proto: !0, forced: y || U }, z);
      return (
        (!r || k) && I[m] !== N && h(I, m, N, { name: M }),
        (f[_] = N),
        z
      );
    }),
...
function Rl() {
  ...
  ba = a(
    ...
    "Array",
    function (v, g) {
      h(this, { type: l, target: n(v), index: 0, kind: g });
    },
    function () {
      var v = c(this),
        g = v.target,
        d = v.index++;
      if (!g || d >= g.length) return ((v.target = null), s(void 0, !0));
      switch (v.kind) {
        case "keys":
          return s(d, !1);
        case "values":
  ...
  if ((e("keys"), e("values"), e("entries"), !o && u && f.name !== "values"))
    try {
      i(f, "name", { value: "values" });
    } catch {}
  return ba;
}
Rl();
      ...
      return function (u, l, h, c) {
        ...
        if (h < 2)
          for (;;) {
            ...
            if (((d += p), o ? d < 0 : g <= d)) throw new i(a);
          }
        for (; o ? d >= 0 : g > d; d += p) d in v && (c = l(c, v[d], d, f));
        return c;
      };
    };
  return ((Ta = { left: s(!1), right: s(!0) }), Ta);
}
var Sa, ou;
function Cl() {
  if (ou) return Sa;
...
function Xh() {
  ...
  var n = le(),
    ...
    f =
      ...
      !c &&
      !!(function () {
        var v = r(String.prototype, "endsWith");
        return v && !v.writable;
      })();
  return (
    n(
        ...
        return [
          ...
          function (V, P) {
            ...
            for (var N = 0, L = 0, B = []; L < w.length; ) {
              ...
              if (
                z === null ||
                (X = p(u(I.lastIndex + (g ? L : 0)), w.length)) === N
              )
                L = o(w, L, A);
              else {
                if ((y(B, m(w, N, L)), B.length === j)) return B;
                for (var H = 1; H <= z.length - 1; H++)
                  if ((y(B, z[H]), B.length === j)) return B;
                L = N = X;
              }
            }
            return (y(B, m(w, N)), B);
...
var gu;
function Jh() {
  if (gu) return lr.exports;
  gu = 1;
  for (
    var n = Zh(),
      e = typeof window > "u" ? globalThis : window,
      r = ["moz", "webkit"],
      t = "AnimationFrame",
      i = e["request" + t],
...
function rv() {
  ...
  return ((Ca = { start: o(1), end: o(2), trim: o(3) }), Ca);
}
var wa, mu;
function tv() {
  if (mu) return wa;
...
function hv(n) {
  ...
  for (var r = 0; r < n.length; r++) {
    ...
    else if (t.type === T.MOVE_TO)
      e += (t.relative ? "m" : "M") + t.x + " " + t.y;
    else if (t.type === T.LINE_TO)
      e += (t.relative ? "l" : "L") + t.x + " " + t.y;
    else if (t.type === T.CURVE_TO)
      e +=
        (t.relative ? "c" : "C") +
        t.x1 +
        " " +
        ...
        " " +
        t.y;
    else if (t.type === T.SMOOTH_CURVE_TO)
      e += (t.relative ? "s" : "S") + t.x2 + " " + t.y2 + " " + t.x + " " + t.y;
    else if (t.type === T.QUAD_TO)
      e += (t.relative ? "q" : "Q") + t.x1 + " " + t.y1 + " " + t.x + " " + t.y;
    else if (t.type === T.SMOOTH_QUAD_TO)
...
function Ia(n, e, r) {
  ...
  var o = Da([(e - a) / 2, (r - s) / 2], (-n.xRot / 180) * Ge),
    u = o[0],
    l = o[1],
  ...
  var c = Math.pow(t, 2) * Math.pow(l, 2) + Math.pow(i, 2) * Math.pow(u, 2),
    ...
    v = ((t * l) / i) * f,
    g = ((-i * u) / t) * f,
    d = Da([v, g], (n.xRot / 180) * Ge);
  ((n.cX = d[0] + (e + a) / 2),
    (n.cY = d[1] + (r + s) / 2),
    (n.phi1 = Math.atan2((l - g) / i, (u - v) / t)),
    (n.phi2 = Math.atan2((-l - g) / i, (-u - v) / t)),
    n.sweepFlag === 0 && n.phi2 > n.phi1 && (n.phi2 -= 2 * Ge),
    n.sweepFlag === 1 && n.phi2 < n.phi1 && (n.phi2 += 2 * Ge),
    (n.phi1 *= 180 / Ge),
    (n.phi2 *= 180 / Ge));
}
function Pu(n, e, r) {
...
(function (n) {
  ...
  function r() {
    var o = NaN,
      ...
      l = NaN,
      h = NaN;
    return i(function (c, f, v) {
      return (
        c.type & T.SMOOTH_CURVE_TO &&
          ((c.type = T.CURVE_TO),
          (o = isNaN(o) ? f : o),
          (u = isNaN(u) ? v : u),
          (c.x1 = c.relative ? f - o : 2 * f - o),
          (c.y1 = c.relative ? v - u : 2 * v - u)),
        c.type & T.CURVE_TO
          ? ((o = c.relative ? f + c.x2 : c.x2),
            (u = c.relative ? v + c.y2 : c.y2))
          : ((o = NaN), (u = NaN)),
        c.type & T.SMOOTH_QUAD_TO &&
          ((c.type = T.QUAD_TO),
          (l = isNaN(l) ? f : l),
          (h = isNaN(h) ? v : h),
          (c.x1 = c.relative ? f - l : 2 * f - l),
          (c.y1 = c.relative ? v - h : 2 * v - h)),
        c.type & T.QUAD_TO
          ? ((l = c.relative ? f + c.x1 : c.x1),
            (h = c.relative ? v + c.y1 : c.y1))
          : ((l = NaN), (h = NaN)),
        c
      );
    });
    ...
    return i(function (l, h, c) {
      if (
        ...
        var f = l.x1,
          v = l.y1;
        ((l.type = T.CURVE_TO),
          (l.x1 = ((l.relative ? 0 : h) + 2 * f) / 3),
          (l.y1 = ((l.relative ? 0 : c) + 2 * v) / 3),
          (l.x2 = (l.x + 2 * f) / 3),
          (l.y2 = (l.y + 2 * v) / 3));
      } else ((o = NaN), (u = NaN));
      return l;
  ...
  function i(o) {
    var u = 0,
      ...
      c = NaN;
    return function (f) {
      if (isNaN(h) && !(f.type & T.MOVE_TO))
        throw new Error("path must start with moveto");
      var v = o(f, u, l, h, c);
      return (
        f.type & T.CLOSE_PATH && ((u = h), (l = c)),
        f.x !== void 0 && (u = f.relative ? u + f.x : f.x),
        f.y !== void 0 && (l = f.relative ? l + f.y : f.y),
        f.type & T.MOVE_TO && ((h = u), (c = l)),
        v
      );
    };
  }
  function a(o, u, l, h, c, f) {
    return (
      Ee(o, u, l, h, c, f),
      i(function (v, g, d, p) {
        var y = v.x1,
          ...
          x = v.x !== void 0 ? v.x : b ? 0 : g,
          S = v.y !== void 0 ? v.y : b ? 0 : d;
        function E(z) {
          return z * z;
        }
        (v.type & T.HORIZ_LINE_TO &&
          u !== 0 &&
          ((v.type = T.LINE_TO), (v.y = v.relative ? 0 : d)),
          v.type & T.VERT_LINE_TO &&
            l !== 0 &&
            ((v.type = T.LINE_TO), (v.x = v.relative ? 0 : g)),
          v.x !== void 0 && (v.x = v.x * o + S * l + (b ? 0 : c)),
          v.y !== void 0 && (v.y = x * u + v.y * h + (b ? 0 : f)),
          v.x1 !== void 0 && (v.x1 = v.x1 * o + v.y1 * l + (b ? 0 : c)),
          v.y1 !== void 0 && (v.y1 = y * u + v.y1 * h + (b ? 0 : f)),
          v.x2 !== void 0 && (v.x2 = v.x2 * o + v.y2 * l + (b ? 0 : c)),
          v.y2 !== void 0 && (v.y2 = m * u + v.y2 * h + (b ? 0 : f)));
        var O = o * h - u * l;
        if (v.xRot !== void 0 && (o !== 1 || u !== 0 || l !== 0 || h !== 1))
          if (O === 0)
            (delete v.rX,
              delete v.rY,
              delete v.xRot,
            ...
            var _ = (v.xRot * Math.PI) / 180,
              ...
              A = E(V) * M + E(P) * w,
              U = k * h * h - R * u * h + A * u * u,
              I = R * (o * h + u * l) - 2 * (k * l * h + A * o * u),
              j = k * l * l - R * o * l + A * o * o,
              N = ((Math.atan2(I, U - j) + Math.PI) % Math.PI) / 2,
              L = Math.sin(N),
              B = Math.cos(N);
            ((v.rX = Math.abs(O) / Math.sqrt(U * E(B) + I * L * B + j * E(L))),
              (v.rY = Math.abs(O) / Math.sqrt(U * E(L) - I * L * B + j * E(B))),
              (v.xRot = (180 * N) / Math.PI));
          }
        return (
          v.sweepFlag !== void 0 && 0 > O && (v.sweepFlag = +!v.sweepFlag),
          v
        );
      })
    );
  ...
  ((n.ROUND = function (o) {
    ...
    (n.NORMALIZE_HVZ = function (o, u, l) {
      return (
        ...
        u === void 0 && (u = !0),
        l === void 0 && (l = !0),
        i(function (h, c, f, v, g) {
          if (isNaN(v) && !(h.type & T.MOVE_TO))
            throw new Error("path must start with moveto");
          return (
            u &&
              h.type & T.HORIZ_LINE_TO &&
              ((h.type = T.LINE_TO), (h.y = h.relative ? 0 : f)),
            l &&
              h.type & T.VERT_LINE_TO &&
              ((h.type = T.LINE_TO), (h.x = h.relative ? 0 : c)),
            o &&
              h.type & T.CLOSE_PATH &&
              ((h.type = T.LINE_TO),
              (h.x = h.relative ? v - c : v),
              (h.y = h.relative ? g - f : g)),
            h.type & T.ARC &&
              (h.rX === 0 || h.rY === 0) &&
              ((h.type = T.LINE_TO),
              delete h.rX,
    ...
    (n.SANITIZE = function (o) {
      ...
      var u = NaN,
        ...
        h = NaN,
        c = NaN;
      return i(function (f, v, g, d, p) {
        var y = Math.abs,
          m = !1,
          b = 0,
          x = 0;
        if (
          (f.type & T.SMOOTH_CURVE_TO &&
            ((b = isNaN(u) ? 0 : v - u), (x = isNaN(l) ? 0 : g - l)),
          f.type & (T.CURVE_TO | T.SMOOTH_CURVE_TO)
            ? ((u = f.relative ? v + f.x2 : f.x2),
              (l = f.relative ? g + f.y2 : f.y2))
            : ((u = NaN), (l = NaN)),
          f.type & T.SMOOTH_QUAD_TO
            ? ((h = isNaN(h) ? v : 2 * v - h), (c = isNaN(c) ? g : 2 * g - c))
            : f.type & T.QUAD_TO
              ? ((h = f.relative ? v + f.x1 : f.x1),
                (c = f.relative ? g + f.y1 : f.y2))
              : ((h = NaN), (c = NaN)),
          f.type & T.LINE_COMMANDS ||
            (f.type & T.ARC && (f.rX === 0 || f.rY === 0 || !f.lArcFlag)) ||
            f.type & T.CURVE_TO ||
            f.type & T.SMOOTH_CURVE_TO ||
            f.type & T.QUAD_TO ||
            f.type & T.SMOOTH_QUAD_TO)
        ) {
          var S = f.x === void 0 ? 0 : f.relative ? f.x : f.x - v,
            E = f.y === void 0 ? 0 : f.relative ? f.y : f.y - g;
          ((b = isNaN(h)
            ? f.x1 === void 0
              ? b
              : f.relative
            ...
            (x = isNaN(c)
              ? f.y1 === void 0
                ...
                : f.relative
                  ...
                  : f.y1 - g
              : c - g));
          var O = f.x2 === void 0 ? 0 : f.relative ? f.x : f.x2 - v,
            _ = f.y2 === void 0 ? 0 : f.relative ? f.y : f.y2 - g;
          y(S) <= o &&
            y(E) <= o &&
            y(b) <= o &&
            y(x) <= o &&
        ...
        return (
          f.type & T.CLOSE_PATH && y(v - d) <= o && y(g - p) <= o && (m = !0),
          m ? [] : f
        );
      });
    }),
    ...
    (n.ROTATE = function (o, u, l) {
      (u === void 0 && (u = 0), l === void 0 && (l = 0), Ee(o, u, l));
      var h = Math.sin(o),
        c = Math.cos(o);
      return a(c, h, -h, c, u - u * c + l * h, l - u * h - l * c);
    }),
    (n.TRANSLATE = function (o, u) {
      return (u === void 0 && (u = 0), Ee(o, u), a(1, 0, 0, 1, o, u));
    }),
    (n.SCALE = function (o, u) {
      return (u === void 0 && (u = o), Ee(o, u), a(o, 0, 0, u, 0, 0));
    }),
    (n.SKEW_X = function (o) {
      return (Ee(o), a(1, 0, Math.atan(o), 1, 0, 0));
    }),
    (n.SKEW_Y = function (o) {
      return (Ee(o), a(1, Math.atan(o), 0, 1, 0, 0));
    }),
    (n.X_AXIS_SYMMETRY = function (o) {
      return (o === void 0 && (o = 0), Ee(o), a(-1, 0, 0, 1, o, 0));
    }),
    (n.Y_AXIS_SYMMETRY = function (o) {
      return (o === void 0 && (o = 0), Ee(o), a(1, 0, 0, -1, 0, o));
    }),
    (n.A_TO_C = function () {
      return i(function (o, u, l) {
        return T.ARC === o.type
          ? (function (h, c, f) {
              ...
              for (
                ...
                var _ = Au(h.phi1, h.phi2, O / b),
                  V = Au(h.phi1, h.phi2, (O + 1) / b),
                  P = V - _,
                  M = (4 / 3) * Math.tan((P * Le) / 4),
                  w = [
                    Math.cos(_ * Le) - M * Math.sin(_ * Le),
                    Math.sin(_ * Le) + M * Math.cos(_ * Le),
                  ],
                  k = w[0],
                  R = w[1],
                  A = [Math.cos(V * Le), Math.sin(V * Le)],
                  U = A[0],
                  I = A[1],
                  j = [U + M * Math.sin(V * Le), I - M * Math.cos(V * Le)],
                  N = j[0],
                  L = j[1];
                x[O] = { relative: h.relative, type: T.CURVE_TO };
                var B = function (z, X) {
                  var H = Da([z * h.rX, X * h.rY], h.xRot),
                    Q = H[0],
                    Fe = H[1];
    ...
    (n.CALCULATE_BOUNDS = function () {
      var o = function (f) {
        ...
        c = i(function (f, v, g) {
          ...
          if (
            (d.type & T.DRAWING_COMMANDS && (p(v), y(g)),
            d.type & T.HORIZ_LINE_TO && p(d.x),
            d.type & T.VERT_LINE_TO && y(d.y),
            d.type & T.LINE_TO && (p(d.x), y(d.y)),
            d.type & T.CURVE_TO)
          ) {
            (p(d.x), y(d.y));
            for (var m = 0, b = Nu(v, d.x1, d.x2, d.x); m < b.length; m++)
              0 < (N = b[m]) && 1 > N && p(_u(v, d.x1, d.x2, d.x, N));
            for (var x = 0, S = Nu(g, d.y1, d.y2, d.y); x < S.length; x++)
              0 < (N = S[x]) && 1 > N && y(_u(g, d.y1, d.y2, d.y, N));
          }
          if (d.type & T.ARC) {
            (p(d.x), y(d.y), Ia(d, v, g));
            for (
              var E = (d.xRot / 180) * Math.PI,
                O = Math.cos(E) * d.rX,
                _ = Math.sin(E) * d.rX,
                V = -Math.sin(E) * d.rY,
                P = Math.cos(E) * d.rY,
...
`
              ...
              if (
                ...
                if (
                  ...
                  if (this.curNumber && this.curCommandType !== -1) {
                    ...
                    (this.curArgs.push(h),
                      this.curArgs.length === fv[this.curCommandType] &&
                        (T.HORIZ_LINE_TO === this.curCommandType
                          ? a({
                              type: T.HORIZ_LINE_TO,
                              relative: this.curCommandRelative,
                              x: h,
                            })
                          : T.VERT_LINE_TO === this.curCommandType
                            ? a({
                                type: T.VERT_LINE_TO,
                                relative: this.curCommandRelative,
                                y: h,
                              })
                            : this.curCommandType === T.MOVE_TO ||
                                this.curCommandType === T.LINE_TO ||
                                this.curCommandType === T.SMOOTH_QUAD_TO
                              ? (a({
                                ...
                                T.MOVE_TO === this.curCommandType &&
                                  (this.curCommandType = T.LINE_TO))
                              : this.curCommandType === T.CURVE_TO
                                ? a({
                                    type: T.CURVE_TO,
                                    relative: this.curCommandRelative,
                                    x1: this.curArgs[0],
                                ...
                                : this.curCommandType === T.SMOOTH_CURVE_TO
                                  ? a({
                                      type: T.SMOOTH_CURVE_TO,
                                      relative: this.curCommandRelative,
                                      x2: this.curArgs[0],
                                      y2: this.curArgs[1],
                                      x: this.curArgs[2],
                    ...
                    if (o === "," && this.canParseCommandOrComma)
                      ...
                      if (l)
                        ...
                        if (
                          ...
                          if (o === "h" || o === "H")
                            ((this.curCommandType = T.HORIZ_LINE_TO),
                              (this.curCommandRelative = o === "h"));
                          else if (o === "v" || o === "V")
                            ((this.curCommandType = T.VERT_LINE_TO),
  ...
  fv =
    (((Se = {})[T.MOVE_TO] = 2),
    (Se[T.LINE_TO] = 2),
    (Se[T.HORIZ_LINE_TO] = 1),
    (Se[T.VERT_LINE_TO] = 1),
    (Se[T.CLOSE_PATH] = 0),
    (Se[T.QUAD_TO] = 4),
    (Se[T.SMOOTH_QUAD_TO] = 2),
    (Se[T.CURVE_TO] = 6),
    (Se[T.SMOOTH_CURVE_TO] = 4),
    (Se[T.ARC] = 7),
    Se),
  qu = {},
  Na,
...
function bv(n, e, r, t, i) {
  if (
    (typeof n == "string" && (n = document.getElementById(n)),
    !n || wr(n) !== "object" || !("getContext" in n))
  )
    throw new TypeError(
...
function xv(n, e, r, t, i, a) {
  if (!(isNaN(a) || a < 1)) {
    a |= 0;
    var s = bv(n, e, r, t, i);
    ((s = Ov(s, e, r, t, i, a)), n.getContext("2d").putImageData(s, e, r));
  }
}
function Ov(n, e, r, t, i, a) {
  for (
    var s = n.data,
      o = 2 * a + 1,
      u = t - 1,
    ...
    ((v = v.next = new Lu()), d === h && (g = v));
  v.next = f;
  for (
    var p = null, y = null, m = 0, b = 0, x = yv[a], S = mv[a], E = 0;
    E < i;
    E++
  ) {
    v = f;
    for (
      var O = s[b], _ = s[b + 1], V = s[b + 2], P = s[b + 3], M = 0;
      M < h;
      M++
    )
      ((v.r = O), (v.g = _), (v.b = V), (v.a = P), (v = v.next));
    for (
      var w = 0,
        k = 0,
        R = 0,
  ...
  for (var ge = 0; ge < t; ge++) {
    ...
    for (var or = 0; or < h; or++)
      ((v.r = ve), (v.g = xe), (v.b = C), (v.a = q), (v = v.next));
    for (var Or = t, Hr = 0, Wr = 0, Yr = 0, Xr = 0, Tr = 1; Tr <= a; Tr++) {
      b = (Or + ge) << 2;
      var Sr = h - Tr;
      ((Ve += (v.r = ve = s[b]) * Sr),
        (Oe += (v.g = xe = s[b + 1]) * Sr),
...
var Vc = Object.freeze({ __proto__: null, offscreen: Tv, node: Sv });
function nr(n) {
...
var Cv = /^[A-Z-]+$/;
function wv(n) {
  return Cv.test(n) ? n.toLowerCase() : n;
}
function Nl(n) {
  var e = /url\(('([^']+)'|"([^"]+)"|([^'")]+))\)/.exec(n) || [];
  return e[2] || e[3] || e[4];
...
var Av = /(\[[^\]]+\])/g,
  Iv = /(#[^\s+>~.[:]+)/g,
  Nv = /(\.[^\s+>~.[:]+)/g,
  _v = /(::[^\s+>~.[:]+|:first-line|:first-letter|:before|:after)/gi,
  Mv = /(:[\w-]+\([^)]*\))/gi,
  qv = /(:[^\s+>~.[:]+)/g,
  Dv = /([^\s+>~.[:]+)/g;
function Ye(n, e) {
  ...
  getColor(e) {
    ...
    return (
      this.isNormalizedColor ||
        ((this.isNormalizedColor = !0), (r = Pv(r)), (this.value = r)),
      r
    );
  }
  getDpi() {
...
var _l = typeof window < "u" ? window : null,
  Ml = typeof fetch < "u" ? fetch.bind(void 0) : null;
class Ur {
  constructor(e) {
    var { fetch: r = Ml, window: t = _l } =
    ...
    ((this.ctx = e),
      ...
      (this.viewPort = new Lv()),
      (this.mouse = new kv(this)),
      (this.animations = []),
      (this.waits = []),
  ...
  setViewBox(e) {
    ...
    (x === "meet" && ((V *= O), (P *= O)),
      x === "slice" && ((V *= _), (P *= _)));
    var M = new D(r, "refX", c),
      w = new D(r, "refY", f),
      k = M.hasValue() && w.hasValue();
    if ((k && t.translate(-O * M.getPixels("x"), -O * w.getPixels("y")), v)) {
      var R = O * g,
        A = O * d;
      (t.beginPath(),
        t.moveTo(R, A),
    ...
    if (!k) {
      var U = x === "meet" && O === E,
        ...
        j = x === "meet" && O === S,
        N = x === "slice" && _ === S;
      (b.startsWith("xMid") && (U || I) && t.translate(a / 2 - V / 2, 0),
        b.endsWith("YMid") && (j || N) && t.translate(0, o / 2 - P / 2),
        b.startsWith("xMax") && (U || I) && t.translate(a - V, 0),
        b.endsWith("YMax") && (j || N) && t.translate(0, o - P));
    }
    switch (!0) {
      case b === "none":
        t.scale(S, E);
          ...
          ((d = Date.now()),
            ...
            y >= g &&
              ...
              this.shouldUpdate(i, o) &&
                (this.render(e, a, s, u, l, h, c), v.runEvents())),
            (this.intervalId = Ea(m)));
        };
      (t || v.start(), (this.intervalId = Ea(m)));
    }
  }
  stop() {
  ...
  render(e, r, t, i, a, s, o) {
    ...
    var g = e.getStyle("width"),
      d = e.getStyle("height");
    !r &&
      (f || (typeof i != "number" && typeof a != "number")) &&
      (g.hasValue() &&
        ((v.width = g.getPixels("x")),
        v.style && (v.style.width = "".concat(v.width, "px"))),
      d.hasValue() &&
        ((v.height = d.getPixels("y")),
    ...
    if (
      (r &&
        g.hasValue() &&
        d.hasValue() &&
        ((p = g.getPixels("x")), (y = d.getPixels("y"))),
      h.setCurrent(p, y),
      ...
      var m = de(e.getAttribute("viewBox").getString()),
        b = 0,
        x = 0;
      if (typeof i == "number") {
    ...
    (t || c.clearRect(0, 0, p, y), e.render(c), f && (this.isFirstRender = !1));
  }
}
Ur.defaultWindow = _l;
Ur.defaultFetch = Ml;
var { defaultFetch: jv } = Ur,
  Bv = typeof DOMParser < "u" ? DOMParser : null;
class _a {
  constructor() {
    var { fetch: e = jv, DOMParser: r = Bv } =
      arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
...
class ql {
  ...
  unapply(e) {
    var { originX: r, originY: t, matrix: i } = this,
      ...
      f = 0,
      v = 1,
      g = 1 / (a * (l * v - h * f) - s * (u * v - h * c) + o * (u * f - l * c)),
      d = r.getPixels("x"),
      p = t.getPixels("y");
    (e.translate(d, p),
      e.transform(
...
class K {
  ...
  addChild(e) {
    ...
    ((r.parent = this),
      K.ignoreChildTypes.includes(r.type) || this.children.push(r));
  }
  matchesSelector(e) {
    var r,
      { node: t } = this;
...
function Kv(n) {
  return typeof process > "u" ? n : n.trim().split(",").map(Xv).join(",");
}
function Qv(n) {
  if (!n) return "";
...
class Pe {
  ...
  bezierCurveAdd(e, r, t, i, a) {
    ...
    if (!(h < 0)) {
      ...
      var f = (-s - Math.sqrt(h)) / (2 * o);
      0 < f &&
        f < 1 &&
        (e
          ? this.addX(this.sumCubic(f, r, t, i, a))
          : this.addY(this.sumCubic(f, r, t, i, a)));
    }
  }
...
class rr extends K {
  ...
  setContext(e) {
    ...
    if (!r) {
      ...
      if (i.hasValue()) {
        var l = new D(this.document, "fill", e.fillStyle)
          .addOpacity(i)
          .getColor();
        e.fillStyle = l;
      }
      ...
      if (s.hasValue()) {
        var f = new D(this.document, "stroke", e.strokeStyle)
          .addOpacity(s)
          .getString();
        e.strokeStyle = f;
      }
      ...
      if (
        ...
        m.hasValue() && m.getString() !== "none")
      ) {
        var x = de(m.getString());
        ...
        typeof e.lineDashOffset < "u"
          ...
          : typeof e.webkitLineDashOffset < "u"
            ? (e.webkitLineDashOffset = S)
            : typeof e.mozDashOffset < "u" && (e.mozDashOffset = S);
      }
    }
    if (((this.modifiedEmSizeStack = !1), typeof e.font < "u")) {
      var E = this.getStyle("font"),
        ...
        V = this.getStyle("font-weight"),
        P = this.getStyle("font-size"),
        M = this.getStyle("font-family"),
        w = new oe(
          O.getString(),
          _.getString(),
          V.getString(),
          P.hasValue() ? "".concat(P.getPixels(!0), "px") : "",
          M.getString(),
          oe.parse(E.getString(), e.font),
        );
      (O.setValue(w.fontStyle),
        _.setValue(w.fontVariant),
        V.setValue(w.fontWeight),
        P.setValue(w.fontSize),
        M.setValue(w.fontFamily),
        (e.font = w.toString()),
        P.isPixels() &&
          ((this.document.emSize = P.getPixels()),
...
class Y extends rr {
  constructor(e, r, t) {
    (super(e, r, t),
      ...
      (this.pathParser = new F(this.getAttribute("d").getString())));
  }
  path(e) {
  ...
  renderChildren(e) {
    ...
    if (t) {
      ...
      if (s.isUrlDefinition())
        for (var c = s.getDefinition(), f = 1; f < i; f++) {
          var [v, g] = t[f];
          c.render(e, v, g);
        }
  ...
  pathC(e, r) {
    var { pathParser: t } = this,
      { current: i, point: a, controlPoint: s, currentPoint: o } = Y.pathC(t);
    (t.addMarker(o, s, a),
  ...
  pathS(e, r) {
    var { pathParser: t } = this,
      { current: i, point: a, controlPoint: s, currentPoint: o } = Y.pathS(t);
    (t.addMarker(o, s, a),
      r.addBezierCurve(i.x, i.y, a.x, a.y, s.x, s.y, o.x, o.y),
      e && e.bezierCurveTo(a.x, a.y, s.x, s.y, o.x, o.y));
  }
  ...
  pathQ(e, r) {
    var { pathParser: t } = this,
      { current: i, controlPoint: a, currentPoint: s } = Y.pathQ(t);
    (t.addMarker(s, a, a),
  ...
  pathT(e, r) {
    var { pathParser: t } = this,
      { current: i, controlPoint: a, currentPoint: s } = Y.pathT(t);
    (t.addMarker(s, a, a),
      r.addQuadraticCurve(i.x, i.y, a.x, a.y, s.x, s.y),
      e && e.quadraticCurveTo(a.x, a.y, s.x, s.y));
  }
  static pathA(e) {
    var { current: r, command: t } = e,
      ...
      f = Math.pow(c.x, 2) / Math.pow(i, 2) + Math.pow(c.y, 2) / Math.pow(a, 2);
  ...
  pathA(e, r) {
    var { pathParser: t } = this,
      ...
      f = 1 - o ? 1 : -1,
      v = h + f * (c / 2),
      g = new J(l.x + a * Math.cos(v), l.y + s * Math.sin(v));
    if (
      (t.addMarkerAngle(g, v - (f * Math.PI) / 2),
      t.addMarkerAngle(i, v - f * Math.PI),
      r.addPoint(i.x, i.y),
      e && !isNaN(h) && !isNaN(c))
    ) {
      var d = a > s ? a : s,
...
class ze extends rr {
  ...
  getFontSize() {
    var { document: e, parent: r } = this,
      t = oe.parse(e.ctx.font).fontSize,
  ...
  getTextFromNode(e) {
    var r = e || this.node,
      ...
      a = t.length - 1,
      s = nr(r.textContent || "");
    return (i === 0 && (s = Ev(s)), i === a && (s = Rv(s)), s);
  }
  renderChildren(e) {
    if (this.type !== "text") {
    ...
    if (a) {
      for (
        ...
        ((e.lineWidth = (e.lineWidth * s) / u),
          ...
          typeof f[g] < "u" && !isNaN(f[g]) && (this.x += f[g]));
      }
      return;
    }
    var { x: y, y: m } = this;
    (e.fillStyle && e.fillText(i, y, m),
      e.strokeStyle && e.strokeText(i, y, m));
  }
  applyAnchoring() {
  ...
  adjustChildCoordinates(e, r, t, i) {
    ...
    return (
      ...
      (r.y = a.y),
      r.leafTexts.push(a),
      (r.minX = Math.min(r.minX, a.x, a.x + f)),
      (r.maxX = Math.max(r.maxX, a.x, a.x + f)),
      a.clearContext(e),
      e.restore(),
      a
    );
  ...
  measureTargetText(e, r) {
    ...
    if (i) {
      for (
        var a = this.getFontSize(),
          ...
          o = de(t.getAttribute("dx").getString()),
          u = s.length,
          l = 0,
          h = 0;
        h < u;
    ...
    var { width: f } = e.measureText(r);
    return (this.clearContext(e), e.restore(), f);
  }
...
class mr extends rr {
  ...
  setContext(e) {
    ...
    var h = this.getAttribute("refX"),
      ...
      f = this.getAttribute("viewBox"),
      v = f.hasValue() ? de(f.getString()) : null,
      g =
        !this.root &&
    ...
    (v && ((d = v[0]), (p = v[1])),
      this.root ||
        ...
        this.type === "marker" && ((y = d), (m = p), (d = 0), (p = 0))),
  ...
  resize(e) {
    ...
    if (
      ...
      (c.hasValue() && c.setValue("".concat(e, "px")),
        f.hasValue() && f.setValue("".concat(r, "px")));
    }
  }
}
class Ll extends Y {
...
class ac extends K {
  ...
  createPattern(e, r, t) {
    var i = this.getStyle("width").getPixels("x", !0),
      ...
      s = new mr(this.document, null);
    ((s.attributes.viewBox = new D(
      this.document,
      "viewBox",
      this.getAttribute("viewBox").getValue(),
    )),
      (s.attributes.width = new D(this.document, "width", "".concat(i, "px"))),
      (s.attributes.height = new D(
        this.document,
        "height",
        "".concat(a, "px"),
      )),
      (s.attributes.transform = new D(
        this.document,
        "transform",
    ...
    for (var c = -1; c <= 1; c++)
      for (var f = -1; f <= 1; f++)
        (u.save(),
          (s.attributes.x = new D(this.document, "x", c * o.width)),
          (s.attributes.y = new D(this.document, "y", f * o.height)),
          s.render(u),
          u.restore());
    var v = e.createPattern(o, "repeat");
    return v;
  }
}
class nc extends K {
  ...
  render(e, r, t) {
    if (r) {
      ...
      (e.translate(i, a),
        ...
        e.save());
      var u = new mr(this.document, null);
      ((u.type = this.type),
        (u.attributes.viewBox = new D(
          this.document,
          "viewBox",
          this.getAttribute("viewBox").getValue(),
        )),
        (u.attributes.refX = new D(
          this.document,
          "refX",
          this.getAttribute("refX").getValue(),
        )),
        (u.attributes.refY = new D(
          this.document,
          "refY",
          this.getAttribute("refY").getValue(),
        )),
        (u.attributes.width = new D(
          this.document,
          "width",
          this.getAttribute("markerWidth").getValue(),
        )),
        (u.attributes.height = new D(
          this.document,
          "height",
          this.getAttribute("markerHeight").getValue(),
        )),
        (u.attributes.overflow = new D(
          this.document,
          "overflow",
          this.getAttribute("overflow").getValue(),
        )),
        (u.attributes.fill = new D(
          this.document,
          "fill",
          this.getAttribute("fill").getColor("black"),
        )),
        (u.attributes.stroke = new D(
          this.document,
          "stroke",
  ...
  createGradient(e, r, t) {
    ...
    if (
      ...
      var { document: o } = this,
        ...
        [h] = l.viewPorts,
        c = new Ll(o, null);
      ((c.attributes.x = new D(o, "x", -u / 3)),
        (c.attributes.y = new D(o, "y", -u / 3)),
        (c.attributes.width = new D(o, "width", u)),
        (c.attributes.height = new D(o, "height", u)));
      var f = new nn(o, null);
      ((f.attributes.transform = new D(
        o,
        "transform",
        ...
        (f.children = [c]));
      var v = new mr(o, null);
      ((v.attributes.x = new D(o, "x", 0)),
        (v.attributes.y = new D(o, "y", 0)),
        (v.attributes.width = new D(o, "width", h.width)),
        (v.attributes.height = new D(o, "height", h.height)),
        (v.children = [f]));
      var g = o.createCanvas(h.width, h.height),
        d = g.getContext("2d");
      return ((d.fillStyle = s), v.render(d), d.createPattern(g, "no-repeat"));
    }
    return s;
  }
...
class sn extends K {
  constructor(e, r, t) {
    (super(e, r, t),
      ...
      (this.values = new D(e, "values", null)));
  ...
  getProgress() {
    ...
    if (r.hasValue()) {
      var i = t.progress * (r.getValue().length - 1),
        a = Math.floor(i),
        s = Math.ceil(i);
      ((t.from = new D(e, "from", parseFloat(r.getValue()[a]))),
        (t.to = new D(e, "to", parseFloat(r.getValue()[s]))),
        (t.progress = (i - a) / (s - a)));
  ...
  renderChildren(e) {
    if (this.hasText) {
      ...
      var { document: r, x: t, y: i } = this,
        { mouse: a } = r.screen,
        s = new D(r, "fontSize", oe.parse(r.ctx.font).fontSize);
      a.isWorking() &&
        a.checkBoundingBox(
          this,
          new Pe(t, i - s.getPixels("y"), t + this.measureText(e), i),
        );
...
function Er(n) {
  for (var e = 1; e < arguments.length; e++) {
    ...
    e % 2
      ? Wu(Object(r), !0).forEach(function (t) {
          an(n, t, r[t]);
        })
      : Object.getOwnPropertyDescriptors
        ? Object.defineProperties(n, Object.getOwnPropertyDescriptors(r))
        : Wu(Object(r)).forEach(function (t) {
...
class yc extends ze {
  ...
  findSegmentToFitChar(e, r, t, i, a, s, o, u, l) {
    ...
    var f = this.textHeight / 20,
      v = this.getEquidistantPointOnPath(h, f, 0),
      g = this.getEquidistantPointOnPath(h + c, f, 0),
      d = { p0: v, p1: g },
      p = v && g ? Math.atan2(g.y - v.y, g.x - v.x) : 0;
    if (o) {
      var y = Math.cos(Math.PI / 2 + p) * o,
        m = Math.cos(-p) * o;
      ((d.p0 = Er(Er({}, v), {}, { x: v.x + y, y: v.y + m })),
        (d.p1 = Er(Er({}, g), {}, { x: g.x + y, y: g.y + m })));
    }
  ...
  setTextData(e) {
    if (!this.glyphInfo) {
      ...
      for (var v = 0; v < f; v++) c.push(typeof a[v] < "u" ? a[v] : h);
      var g = c.reduce((x, S, E) => (E === 0 ? 0 : x + S || 0), 0),
  ...
  parsePathData(e) {
    ...
    for (t.reset(); !t.isEnd(); ) {
      ...
      o.type !== F.CLOSE_PATH
        ...
        : r.push({ type: F.CLOSE_PATH, points: [], pathLength: 0 });
    }
    return r;
  }
  pathM(e, r) {
    var { x: t, y: i } = Y.pathM(e).point;
    r.push(t, i);
  }
  pathL(e, r) {
    var { x: t, y: i } = Y.pathL(e).point;
    return (r.push(t, i), F.LINE_TO);
  }
  pathH(e, r) {
    var { x: t, y: i } = Y.pathH(e).point;
    return (r.push(t, i), F.LINE_TO);
  }
  pathV(e, r) {
    var { x: t, y: i } = Y.pathV(e).point;
    return (r.push(t, i), F.LINE_TO);
  }
  pathC(e, r) {
    var { point: t, controlPoint: i, currentPoint: a } = Y.pathC(e);
    r.push(t.x, t.y, i.x, i.y, a.x, a.y);
  }
  pathS(e, r) {
    var { point: t, controlPoint: i, currentPoint: a } = Y.pathS(e);
    return (r.push(t.x, t.y, i.x, i.y, a.x, a.y), F.CURVE_TO);
  }
  pathQ(e, r) {
    var { controlPoint: t, currentPoint: i } = Y.pathQ(e);
    r.push(t.x, t.y, i.x, i.y);
  }
  pathT(e, r) {
    var { controlPoint: t, currentPoint: i } = Y.pathT(e);
  ...
  getPointOnLine(e, r, t, i, a) {
    ...
    var h = u * l,
      c = null;
    if (i === r) c = { x: s, y: o + h };
    else if ((o - t) / (s - r + tr) === u) c = { x: s + l, y: o + h };
    else {
      var f = 0,
        v = 0,
      ...
      ((d /= g * g), (f = r + d * (i - r)), (v = t + d * (a - t)));
      var p = this.getLineLength(s, o, f, v),
        y = Math.sqrt(e * e - p * p);
  ...
  getPointOnCubicBezier(e, r, t, i, a, s, o, u, l) {
    var h = u * Bu(e) + s * Fu(e) + i * Uu(e) + r * Gu(e),
      c = l * Bu(e) + o * Fu(e) + a * Uu(e) + t * Gu(e);
    return { x: h, y: c };
  }
  getPointOnQuadraticBezier(e, r, t, i, a, s, o) {
    var u = s * $u(e) + i * zu(e) + r * Hu(e),
      l = o * $u(e) + a * zu(e) + t * Hu(e);
    return { x: u, y: l };
  }
  ...
  renderChildren(e) {
    ...
    if (t) {
      ...
      if (
        (t.type === "symbol" &&
          ((i = new mr(r, null)),
          (i.attributes.viewBox = new D(
            r,
            "viewBox",
            t.getAttribute("viewBox").getString(),
          )),
          (i.attributes.preserveAspectRatio = new D(
            r,
            "preserveAspectRatio",
            t.getAttribute("preserveAspectRatio").getString(),
          )),
          (i.attributes.overflow = new D(
            r,
            "overflow",
            t.getAttribute("overflow").getString(),
          )),
          (i.children = t.children),
          (t.styles.opacity = new D(r, "opacity", this.calculateOpacity()))),
        i.type === "svg")
      ) {
        var a = this.getStyle("width", !1, !0),
          s = this.getStyle("height", !1, !0);
        (a.hasValue() &&
          (i.attributes.width = new D(r, "width", a.getString())),
          s.hasValue() &&
            (i.attributes.height = new D(r, "height", s.getString())));
      }
      var o = i.parent;
...
function Rr(n, e, r, t, i, a) {
  return n[r * t * 4 + e * 4 + a];
}
function Cr(n, e, r, t, i, a, s) {
  n[r * t * 4 + e * 4 + a] = s;
}
function ie(n, e, r) {
  var t = n[e];
...
class Fl extends K {
  ...
  apply(e, r, t, i, a) {
    for (
      ...
      for (var h = 0; h < i; h++) {
        var c = Rr(u.data, h, l, i, a, 0),
          f = Rr(u.data, h, l, i, a, 1),
          v = Rr(u.data, h, l, i, a, 2),
          g = Rr(u.data, h, l, i, a, 3),
          d =
            ie(o, 0, c) + ie(o, 1, f) + ie(o, 2, v) + ie(o, 3, g) + ie(o, 4, 1),
          p =
            ie(o, 5, c) + ie(o, 6, f) + ie(o, 7, v) + ie(o, 8, g) + ie(o, 9, 1),
          y =
            ie(o, 10, c) +
            ie(o, 11, f) +
            ie(o, 12, v) +
          ...
          m =
            ...
            ie(o, 18, g) +
            ie(o, 19, 1);
        (s && ((d = 0), (p = 0), (y = 0), (m *= g / 255)),
          Cr(u.data, h, l, i, a, 0, d),
          Cr(u.data, h, l, i, a, 1, p),
          Cr(u.data, h, l, i, a, 2, y),
          Cr(u.data, h, l, i, a, 3, m));
      }
...
class $r extends K {
  ...
  apply(e, r) {
    ...
    var l = this.removeStyles(r, $r.ignoreStyles),
    ...
    var f = t.createCanvas(i + s, a + o),
      v = f.getContext("2d");
    (t.screen.setDefaults(v),
      r.render(v),
      (v.globalCompositeOperation = "destination-in"),
      (v.fillStyle = c.createPattern(h, "no-repeat")),
      v.fillRect(0, 0, i + s, a + o),
      (e.fillStyle = v.createPattern(f, "no-repeat")),
...
class Sc extends K {
  ...
  apply(e) {
    ...
    (t && ((t.beginPath = Yu), (t.closePath = Yu)),
      Reflect.apply(i, e, []),
    ...
    if (a) {
      ...
      if (!(h < 1 || c < 1)) {
        ...
        (t.screen.setDefaults(p),
          ...
          e.drawImage(d, 0, 0, h, c, f - s, v - o, h, c),
...
class $e {
  ...
  createElement(e) {
    var r = e.nodeName.replace(/^[^:]+:/, ""),
      t = $e.elementTypes[r];
    return typeof t < "u" ? new t(this, e) : new Yv(this, e);
  }
  createTextNode(e) {
    return new Jv(this, e);
  }
  setViewBox(e) {
    this.screen.setViewBox(Nc({ document: this }, e));
  }
}
$e.createCanvas = _c;
$e.createImage = Mc;
...
class hr {
  constructor(e, r) {
    ...
    ((this.parser = new _a(t)),
      (this.screen = new Ur(e, t)),
      (this.options = t));
    var i = new $e(this, t),
...
export {
  ...
  hr as Canvg,
  ec as CircleElement,
  Sc as ClipPathElement,
  sc as DefsElement,
  Ac as DescElement,
  $e as Document,
  K as Element,
  rc as EllipseElement,
  Fl as FeColorMatrixElement,
  Cc as FeCompositeElement,
  Ec as FeDropShadowElement,
  wc as FeGaussianBlurElement,
  Rc as FeMorphologyElement,
  zr as FilterElement,
  oe as Font,
  cc as FontElement,
  fc as FontFaceElement,
  nn as GElement,
  Vl as GlyphElement,
  jl as GradientElement,
  bc as ImageElement,
  tc as LineElement,
  oc as LinearGradientElement,
  nc as MarkerElement,
  $r as MaskElement,
  ql as Matrix,
  gc as MissingGlyphElement,
  kv as Mouse,
  tr as PSEUDO_ZERO,
  _a as Parser,
  Y as PathElement,
  F as PathParser,
  ac as PatternElement,
  J as Point,
  ic as PolygonElement,
  kl as PolylineElement,
  D as Property,
  $u as QB1,
  zu as QB2,
  Hu as QB3,
  uc as RadialGradientElement,
  Ll as RectElement,
  rr as RenderedElement,
  Uv as Rotate,
  mr as SVGElement,
  Oc as SVGFontLoader,
  Gv as Scale,
  ...
  Gr as TSpanElement,
  ze as TextElement,
  yc as TextPathElement,
  Pc as TitleElement,
  Qe as Transform,
  Fv as Translate,
  Yv as UnknownElement,
  Tc as UseElement,
  Lv as ViewPort,
  nr as compressSpaces,
  hr as default,
  Vv as getSelectorSpecificity,
  wv as normalizeAttributeName,
  Pv as normalizeColor,
